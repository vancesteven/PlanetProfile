...
%% Porosity of the rock
%Planet.POROUS_ICE = 1; % porosity makes no difference for Titan because the seafloor pressures are too high
%Planet.phi_surface = 0.23;
%Params.nsteps_iceI=0;
%PlanetProfile_mod(Planet,Seismic,Params)
