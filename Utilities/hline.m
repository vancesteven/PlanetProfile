function [lineHandles, textHandles] = hline(y, linePropertiesList, label, textPosition, textPropertiesList, axesHandle, isLineColorSynchronizedWithText, xLimits)
...
%
% xLimits: range for the vertical line (taken from 'YLim' of axes if not specified)

% Author:      Hoi Wong (wonghoi.ee@gmail.com)
% Date:        02/14/2008
%
% Updated:     03/11/2011 (Synchronized new features with vline())
%              08/18/2014 (Synchronized new features with vline())
%
% Acknowledgement:  It was based on hline() written by Brandon Kuczenski.
    ...
    lineHandles = plot(axesHandle, Xlimits, [y';y'], linePropertiesList{:}, 'XLimInclude', 'off');
