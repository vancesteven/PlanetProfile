...
def kT(T,varstr):
    ...
    # Metastable ice ?
    valueDict['XII'] = [80.1, 0.77, 100, 115, 140, 4]

    # ASW ???
    valueDict['LDA']= [17.5, 0.55, 0.1, 80, 130, 4]
    valueDict['HDA']= [0.528, 0.026, 0.1, 75, 120, 4]
    valueDict['VHDA']= [0.257, 0.20, 1000, 145, 155, 6]
