...
## Connections
- [[.__call__()_13]] - `method` [EXTRACTED]
- [[.__init__()_22]] - `method` [EXTRACTED]
- [[.__init__()_13]] - `calls` [EXTRACTED]
- [[ClathSeismic]] - `uses` [INFERRED]
- [[Creates a function call for returning seismic properties of depth profile for Se]] - `rationale_for` [EXTRACTED]
- [[EOSLookupTableLoader]] - `uses` [INFERRED]
- [[EOSwrapper]] - `uses` [INFERRED]
- [[GetphiCalc]] - `uses` [INFERRED]
- [[HydroEOS.py]] - `contains` [EXTRACTED]
