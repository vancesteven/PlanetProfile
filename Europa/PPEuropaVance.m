...
Seismic.mantleEOS = 'Europa_CM-CI-67P_silicate_80Fe20S_core_686_fluid_properties_not_included.tab';
Seismic.mantleEOS = 'EM_CI_r0_bulk_rs_planetprofile.tab';
Seismic.mantleEOS = 'Europa_CM_silicate_minus_volatiles_minus_Fe-FeS_eutectic_core_excluding_fluid_properties.tab';
Seismic.mantleEOS = 'Europa_CM_silicate_minus_volatiles_minus_Fe-FeS_eutectic_core_including_fluid_properties.tab';
...
% Seismic.coreEOS = '80Fe20S_core.tab';
Seismic.coreEOS = '76Fe24S_core.tab';

% Seismic.mantleEOS = 'CM_hydrous_differentiated_Ganymede_Core100Fe0S_excluding_fluid_properties.tab';% (2900 for Q= 100 GW, 3240 for Q= 220 GW)
...
% % end
% 
% Planet.rho_sil_withcore_kgm3 = rhos(2,3);
%             PlanetProfile(Planet,Seismic,Params);
% 
% 
% PlanetProfile(Planet,Seismic,Params)
...
% Planet.xFeS_meteoritic = 0.0405; %CM2 mean from Jarosewich 1990
% Planet.xFeS = 0.0; %mass fraction of sulfur in the core
% Planeet.xFe_core = 0.0279 ; % this is the total Fe in Fe and FeS
% Planet.XH2O = 0.0035; % total fraction of water in CM2; use this to compute the excess or deficit indicated by the mineralogical model
% Planet.rho_sil_withcore_kgm3 = 3644;
% Planet.phi_surface = 0;
% PlanetProfile(Planet,Seismic,Params)