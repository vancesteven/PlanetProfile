...
class MagneticSubstruct:
    ...
    def __init__(self):
        ...
        self.iAsymBds = np.empty(0, dtype=int)  # Index of asymShape_m to which the above z values correspond
...
class FigMiscStruct:
    ...
    def SetLatLon(self):
        ...
        self.lonMapTicks_deg = np.linspace(self.lonMin_deg, self.lonMax_deg, self.nLonTicks, dtype=int)
        self.latMapTicks_deg = np.linspace(-90, 90, self.nLatTicks, dtype=int)
