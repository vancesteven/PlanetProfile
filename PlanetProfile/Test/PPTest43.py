"""
PPTest43
Andrade no-ocean Titan: MCMC with Arrhenius melting-point viscosity.

Same interior configuration as PPTest41 (Andrade, no-ocean, Kalousova
convection, self-consistent tidal heating). The MCMC runner
(Test43_mcmc_andrade_arrhenius_no_ocean.py) samples etaMelt — viscosity
