...
def test_scientific_understanding():
    ...
    print("    - Adjust a common seafloor pressure across all columns")
    print("    - Hydrostatic estimate: dM/dP ≈ 4π r_floor²/g_floor")
    print("    - Regenerate every ocean column at the corrected pressure")
    ...
    print("    - Solved profiles use exact per-layer spherical masses")
    print("    - Trapezoidal radial integration is a synthetic-profile fallback")
    print("    - np.abs() handles fallback radii ordered surface-to-depth")
