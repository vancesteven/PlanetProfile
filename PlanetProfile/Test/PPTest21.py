...
Planet.Bulk.Tb_K = Constants.TtripleIh_III_L_K - 20 # Set the Tb_K to be slightly below the triple point to ensure we are in the ice Ih to high pressure ice phase transition
