"""
PPTest30
Europa-like, Seawater model with specified hydrosphere pressure at seafloor with constant inner density (MoI is inferred from bulk mass, radius, and hydrosphere pressure at seafloor)
