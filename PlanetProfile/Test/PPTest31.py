"""
PPTest31
Ganymede-like with Kalousova et al. (2018) HP ice convection
Tests KALOUSOVA_CONVECTION flag and triple-point temperature limits for ice III and V
Modeled after PPTest20 but with Kalousova convection enabled
...
Planet.Steps.nIceIIILitho = 20  # Add more steps for HP ice layers
