"""
PPTest32
Ganymede-like with Kalousova et al. (2018) HP ice convection - sub-critical regime
Lower Tb and very low silicate heating to produce thin HP ice with Ra* < Ra*_c
Expected: no temperate layer for some/all HP ice phases
For testing purposes
"""
import numpy as np
from PlanetProfile.Utilities.defineStructs import PlanetStruct, Constants

Planet = PlanetStruct('Test32')
...
Planet.Bulk.Tb_K = 260.0  # Lower than Test30 (267.0) for thinner HP ice
...
Planet.Sil.Htidal_Wm3 = 1e-19  # Very low silicate heating -> low q_s -> subcritical
# Rock porosity
