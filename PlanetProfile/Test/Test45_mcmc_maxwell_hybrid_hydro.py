...
def make_plots(samples, log_likes, k2_results, mtot_results, cmr2_results,
    ...
    _save(fig, 'hybrid_hydro_corner.png')
    ...
    ax.legend()
    _save(fig, 'hybrid_hydro_k2_scatter.png')
    ...
    ax.legend()
    _save(fig, 'hybrid_hydro_k2_scatter_heating.png')
    ...
    fig.tight_layout()
    _save(fig, 'hybrid_hydro_heating.png')
    ...
    fig.tight_layout()
    _save(fig, 'hybrid_hydro_mass_cmr2.png')
    ...
    _save(fig, 'hybrid_hydro_cmr2_surface.png')
    ...
    if any(np.isfinite(v) for v in diceIh_line):
        ...
        fig.tight_layout()
    _save(fig, 'hybrid_hydro_Tb_structure.png')
...
if __name__ == '__main__':
    ...
    pkl_path = os.path.join(OUTPUT_DIR, 'hybrid_hydro_mcmc.pkl')
