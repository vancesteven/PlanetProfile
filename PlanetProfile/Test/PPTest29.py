...
Planet.Lateral.gridType = 'latlon'  # Use latlon grid (no healpy dependency)
Planet.Lateral.nLat = 12
Planet.Lateral.nLon = 24
Planet.Lateral.DO_MASS_CONSERVE = True

# Prescribe degree-2 ice thickness variation via SH coefficients
# C00 = mean ice thickness (~29 km for Europa), C20 = degree-2 variation (5 km)
...
Planet.Lateral.dIce_Cpq_km[0, 0] = 29.0  # Mean ice thickness in km
Planet.Lateral.dIce_Cpq_km[2, 0] = 5.0   # Degree-2, order-0 variation (pole-to-equator)
