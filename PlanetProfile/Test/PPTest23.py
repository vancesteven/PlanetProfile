"""
PPTest23
Europa-like, pure water model with mixed clathrate-Ih underplate layer (Modeled after PPTest3 that uses pure clathrate)
For testing purposes
"""
import numpy as np
from PlanetProfile.Utilities.defineStructs import PlanetStruct, Constants

Planet = PlanetStruct('Test23')
