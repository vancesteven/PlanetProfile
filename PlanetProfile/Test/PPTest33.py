"""
PPTest33
Ganymede-like with Kalousova et al. (2018) HP ice convection - super-critical regime
Higher Tb and high silicate heating to produce thick HP ice with Ra* >> Ra*_c
Expected: temperate layers present, active partial melting in HP ice
Also tests ice tidal heating (HtidalIce_Wm3 > 0)
For testing purposes
"""
import numpy as np
from PlanetProfile.Utilities.defineStructs import PlanetStruct, Constants

Planet = PlanetStruct('Test33')
...
Planet.Bulk.Tb_K = 270.0  # Higher than Test30 (267.0) for thicker HP ice
...
""" Ice tidal heating """
Planet.Ocean.HtidalIce_Wm3 = 1e-9  # Tidal heating in ice layers
...
Planet.Sil.Htidal_Wm3 = 1e-10  # Higher silicate heating for supercritical regime
# Rock porosity
