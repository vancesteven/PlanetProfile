...
Planet = PlanetStruct('Titania')

Planet.PfreezeLower_MPa = 5
Planet.PfreezeUpper_MPa = 45

""" Bulk planetary settings """
Planet.Bulk.R_m = 788.9e3  # Value from mean radius in Archinal et al. (2018): https://doi.org/10.1007/s10569-017-9805-5
Planet.Bulk.M_kg = 3.527e21  # From Jacobson et al. (1992): https://adsabs.harvard.edu/pdf/1992AJ....103.2068J
Planet.Bulk.Torb_s = 8.7059 * 24 * 3600
