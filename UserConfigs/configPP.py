...
def configAssign():
    ...
    Params.PLOT_PVT_INNER =   True  # Whether to plot silicate/core PT property plots (color property surfaces with the geotherm overlaid; requires Perple_X/EOS tables, i.e. CONSTANT_INNER_DENSITY = False; user default 2026-07-17)
